...
namespace TravelAppXamarin.Helpers
{
    ...
    { 
        ...
        public const string VENUE_SEARCH = "https://nominatim.openstreetmap.org/?addressdetails=1&q={0}&format=json&limit=50";
        ...
        public static string query = "Universities+in+Nigeria";
